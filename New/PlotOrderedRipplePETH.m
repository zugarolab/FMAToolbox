...
%     intervals         intervals to restrict this analysis
%    =========================================================================
%
%  OUTPUT
...
addParameter(p, 'brainRegion', {'PFC', 'MEC', 'EC', 'ILA', 'IL', 'PL','Cortex'}, @(x) iscell(x) || ischar(x));
...
triggerEvents = Restrict(triggerEvents,intervals);
