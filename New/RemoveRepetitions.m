...
% Removes repetitions (e.g. bursting neuron) from a vector or a matrix.
%
%    =========================================================================
%     Properties    Values
%    -------------------------------------------------------------------------
...
%                   changing the order)
%                   'immediate' - removes a value only if it is an
%                   immediate repetition of the value preceding it.
...
%
%   [clean,cleanIndices,discarded] = RemoveRepetitions([1 1 3 4 5 5 5 2 1], 'mode', 'immediate'),
%   clean = [1 3 4 5 2 1];
