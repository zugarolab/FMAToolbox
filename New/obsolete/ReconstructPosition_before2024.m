function [estimations,positions,errors,average] = ReconstructPosition(positions,spikes,windows,varargin)
...
% (C) 2015-2020 by Ralitsa Todorova (log-exp fix, flattening dimensions, options)
%
...
% Check if third argument is phases instead of windows, and give an error if this is the case.
