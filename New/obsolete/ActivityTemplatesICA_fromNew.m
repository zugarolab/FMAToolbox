function [templates,correlations,weights] = ActivityTemplatesICA(spikes,varargin)

%ActivityTemplatesICA - Compute assemblies activity and neurons contribution from PCA of spike trains and ICA.
%
