...
%     'step'        step in s (default = bin size)
%    =========================================================================
%
%  OUTPUT
%
...
% Change signs so that largest weight is always positive
flip = max(eigenvectors)~=max(abs(eigenvectors));
eigenvectors(:,flip) = -eigenvectors(:,flip);
